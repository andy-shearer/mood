...
exports.reIssueAccessToken = exports.createSession = void 0;
...
function createSession(userId, userAgent) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const session = yield session_models_1.default.create({
            user: userId,
            userAgent,
        });
...
function reIssueAccessToken({ refreshToken, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!decoded || !(0, lodash_1.get)(decoded, "session"))
            return false;
        const session = yield session_models_1.default.findById((0, lodash_1.get)(decoded, "session"));
